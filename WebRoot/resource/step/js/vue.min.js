...
! function(t, e) {
    ...
    function xn(n, r) {
        if (!t(n.data.domProps) || !t(r.data.domProps)) {
            var i, o, a = r.elm,
                s = n.data.domProps || {}, c = r.data.domProps || {};
    ...
    function Ir(t, e) {
        if (1 === t.type) {
            ...
            if (t.staticRoot = !1, t.children)
                for (var n = 0, r = t.children.length; n < r; n++) Ir(t.children[n], e || !! t.
                    for);
            if (t.ifConditions)
    ...
    function Mr(t) {
        return 2 !== t.type && (3 === t.type || !(!t.pre && (t.hasBindings || t.
            if ||t.
            for || vi(t.tag) || !ys(t.tag) || Dr(t) || !Object.keys(t).every(ms))))
    }
    ...
    function Ur(t, e) {
        ...
        if (t.
            for && !t.forProcessed) return qr(t, e);
        if (t.
            if &&!t.ifProcessed) return Kr(t, e);
    ...
    function Qr(t, e, n) {
        return e.
        for && !e.forProcessed ? Xr(t, e, n) : "{key:" + t + ",fn:function(" + String(e.attrsMap.scope) + "){return " + ("template" === e.tag ? ti(e, n) || "void 0" : Ur(e, n)) + "}}"
    }
    ...
    function ti(t, e, n, r, i) {
        ...
        if (o.length) {
            var a = o[0];
            if (1 === o.length && a.
                for && "template" !== a.tag && "slot" !== a.tag) return (r || Ur)(a, e);
    ...
    var di = Object.prototype.toString,
        ...
        Ti = /[^\w.$]/,
        Ei = _,
        ji = "__proto__" in {}, Ni = "undefined" != typeof window,
